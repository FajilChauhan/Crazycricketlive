  ...
  return (
    <div className="min-h-[calc(100vh-64px)] bg-[#111] px-3 sm:px-4 md:px-6 py-5 sm:py-8">
      <div className="max-w-xl lg:max-w-2xl mx-auto">
        ...
        {/* Form Card */}
        <div className="bg-[#1a1a1a] border border-white/[0.07] rounded-2xl p-4 sm:p-6 md:p-8">
          <form
          ...
          >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#111] border border-white/[0.08] rounded-xl pl-10 pr-4 py-3.5 text-white text-sm placeholder:text-white/20 focus:outline-none focus:border-green-500/50 focus:ring-1 focus:ring-green-500/20 transition-all"
                />
              </div>
            ...
            <button
              ...
              className="w-full min-h-[48px] bg-green-500 hover:bg-green-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3 rounded-xl text-sm sm:text-base transition-colors mt-2"
            >
              {mutation.isPending
                ? "Creating..."
                : "Create Tournament"}
